...
Plans:
- [x] 12-01-PLAN.md — Strip channel_args, message-watcher, and CLAUDE_CHANNELS from wrapper and env.template
...
Plans:
- [x] 13-01-PLAN.md — Rewrite orchestra CLAUDE.md for claude -p dispatch and update test suite
